...
def main(argv):
   ...
   # options = parser.parse_args(argv)
    ...
    robot = sdk.create_robot(os.environ.get('BOSDYN_CLIENT_HOSTNAME'))
    #robot = sdk.create_robot('131.225.96.246')
    bosdyn.client.util.authenticate(robot)
    #robot.authenticate(ncurfman, RollOverTwice)
        ...
        while True:
           # input("Press Enter to log robot and fiducial positions...")
            ...
            if curr_fname == '':
                ...
                curr_fname, temp_fname = create_csv_filename(1)
